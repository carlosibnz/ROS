...
if(NOT "/home/igor/catkin_ws/devel/include " STREQUAL " ")
  set(geek_gasteiz_INCLUDE_DIRS "")
  set(_include_dirs "/home/igor/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geek_gasteiz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/igor/catkin_ws/src/geek_gasteiz/${idir}'.  ${_report}")
    endif()
